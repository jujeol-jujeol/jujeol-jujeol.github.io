...
- webpack, http-server 등을 이용해 정적 파일을 localhost:3000, localhost:8080 등 localhost로 배포해야 한다.
...
8. 'inspect' 를 클릭하면 모바일 환경에서 동작하는 것을 다음과 같이 모바일 및 PC 화면을 통해 확인할 수 있다.
...
2. 설정 창 가장 우측의 '고급 탭' \> 하단 '메뉴막대에서 개발자용 메뉴 보기' 체크
3. 상단 탭의 '고급 탭'탭을 보면 현재 연결 된 Device 정보를 확인 할 수 있다.
